...
export default function Nav() {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 mt-10 min-h-16 inset-shadow-2xs px-4 md:px-[50px] bg-transparent drop-shadow-lg flex flex-1 items-center justify-between 2xl:[&_*]:text-6xl md:text-3xl">
